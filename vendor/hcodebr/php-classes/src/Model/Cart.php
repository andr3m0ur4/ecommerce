...
class Cart extends Model 
{
	...
	public static function getFromSession ( )
	{
		...
		if ( isset ( $_SESSION[Cart::SESSION] ) AND ( int ) $_SESSION[Cart::SESSION]['idcart'] > 0 ) {
	...
	public function getProducts ( )
	{
		...
		return Product::checkList ( $sql -> select ( "
			SELECT b.idproduct, b.desproduct, b.vlprice, b.vlwidth, b.vlheight, b.vllength, b.vlweight, 
	...
	public function setFreight ( $nrzipcode )
	{
		...
		if ( $totals['nrqtd'] > 0 ) {
			...
			$xml = simplexml_load_file ( 
				'http://ws.correios.com.br/calculador/CalcPrecoPrazo.asmx/CalcPrecoPrazo?' . $qs 
			);
