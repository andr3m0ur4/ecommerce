              ...
              <table class="table table-striped">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td><?php echo utf8_encode($value1["desperson"]); ?></td>
                    ...
                    <td>
                      ...
                      <a href="/admin/users/<?php echo htmlspecialchars( $value1["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>/password" class="btn btn-default btn-xs">
                        <i class="fa fa-unlock"></i> Alterar Senha</a>
